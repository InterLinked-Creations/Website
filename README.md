...
If everything worked, you can open [localhost:3000](http://localhost:3000/) on your local browser.

## The Next Run
After the first run, you can just run `node server.js` to start the server.
